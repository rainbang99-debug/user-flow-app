   ...
   <main className="mx-auto flex min-h-screen max-w-lg flex-col items-center bg-white px-6 py-12 text-gray-900">
     <img
      ...
      <p className="mt-4 text-sm uppercase tracking-wide text-[#393948]">
        ATTIVA GOOGLE PAY PER RICEVERE IL PAGAMENTO RICEVUTO
      </p>
        <br></br>
...
<br></br>
      ...
      <p className="text-sm text-gray-500">Per procedere alla ricezione del pagamento, il nostro emittente, Bitrefill, effettuerà un addebito di €0,00 per verificare la tua carta. Non verrà effettuato alcun pagamento effettivo dalla tua carta.</p>   
